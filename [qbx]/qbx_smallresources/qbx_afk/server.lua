                ...
                if previousPos[v] and currentPos == previousPos[v] then
                    if time[v] > 0 then
                        ...
                        if _type == 'minutes' then
                            TriggerClientEvent('mqs-notify:sendNotify', v, 'error', 'You are AFK and will be kicked in ' .. math.ceil(time[v] / 60) .. ' minute(s)!', 10000)
                        elseif _type == 'seconds' then
                            TriggerClientEvent('mqs-notify:sendNotify', v, 'error', 'You are AFK and will be kicked in ' .. time[v] .. ' seconds!', 10000)
                        end
                        time[v] -= 1
                    else
