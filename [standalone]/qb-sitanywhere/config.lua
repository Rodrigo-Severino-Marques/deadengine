...
Config.Lang = {
    -- Notifications
    Notification = {
        OccupiedSit = "Este assento já está ocupado!",
        OccupiedLay = "Não pode deitar aqui!",
        NoAvailable = "Nenhum assento disponível!",
        NoFound = "Nenhum assento encontrado!",
        NoBedFound = "Nada para deitar encontrado!",
        TooTilted = "Este assento está muito inclinado!",
        CannotReachSeat = "Não pode alcançar este assento!",
        CannotSitInSeat = "Não pode sentar neste assento!",
        CannotReachBed = "Não pode alcançar esta cama/banco!",
        AlreadyAttemptingToSit = "Já está tentando sentar!",
        AlreadyAttemptingToLay = "Já está tentando deitar!"
    },

    -- Chat Suggestions
    ChatSuggestions = {
        Sit = "Sentar no assento mais próximo",
        Lay = "Deitar na cama/banco mais próximo"
    },

    -- Key Mapping
    KeyMapping = {
        SitDown = "Pressiona %s para sentar",
        LayDown = "Pressiona %s para deitar",
        GetUp = "Pressiona %s para levantar"
    },

    -- Description in Settings > Key Bindings > FiveM
    KeyBindingDesc = {
        Keyboard = {
            SitDown = "Sit - Sentar no Assento",
            LayDown = "Sit - Deitar na Cama/Banco",
            GetUp = "Sit - Levantar do Assento/Cama"
        },
        PadAnalog = {
            SitDown = "Sit - Sentar no Assento - Controle",
            LayDown = "Sit - Deitar na Cama/Banco - Controle",
            GetUp = "Sit - Levantar do Assento/Cama - Controle"
        }
    }
}
