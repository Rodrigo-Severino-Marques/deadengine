...
Config.RuralSpeed = 35.0 -- Speed outside any urban zone.

Config.TramSpawnEnabled = true -- Does tram spawn.
Config.FreightSpawnEnabled = true -- Does freight train spawn.

Config.TramSpawnFrequency = 60 -- How often the tram spawns in seconds.
Config.FreightSpawnFrequency = 60 -- How often the freight train spawns in seconds.
